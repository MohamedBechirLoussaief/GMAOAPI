        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleUtilisateur = table.Column<int>(type: "int", nullable: false),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false),
                    Specialite = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RapportId = table.Column<int>(type: "int", nullable: true),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interventions_AspNetUsers_CreateurId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PiecesDetachees_Fournisseurs_FournisseurId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionTechniciens", x => new { x.TechnicienId, x.InterventionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Planifications_Interventions_InterventionId",
                        column: x => x.InterventionId,
                        principalTable: "Interventions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rapports_AspNetUsers_CreateurId",
                        column: x => x.CreateurId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rapports_AspNetUsers_ValideurId",
            ...
            migrationBuilder.CreateTable(
                name: "InterventionPieceDetachees",
                columns: table => new
                {
                    InterventionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionPieceDetachees", x => new { x.InterventionId, x.PieceDetacheeId });
                    table.ForeignKey(
                        name: "FK_InterventionPieceDetachees_Interventions_InterventionId",
                        column: x => x.InterventionId,
                        principalTable: "Interventions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterventionPieceDetachees_PiecesDetachees_PieceDetacheeId",
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { "1", null, "Admin", "ADMIN" },
                    { "2", null, "Technicien", "TECHNICIEN" },
                    { "3", null, "Responsable", "RESPONSABLE" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipements_Reference",
                table: "Equipements",
                column: "Reference",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InterventionPieceDetachees_PieceDetacheeId",
                table: "InterventionPieceDetachees",
                column: "PieceDetacheeId");

            migrationBuilder.CreateIndex(
                name: "IX_Interventions_CreateurId",
                table: "Interventions",
                column: "CreateurId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterventionTechniciens_InterventionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PiecesDetachees_FournisseurId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Planifications_InterventionId",
                table: "Planifications",
                column: "InterventionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Rapports_CreateurId",
                table: "Rapports",
                column: "CreateurId");
